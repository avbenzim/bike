...
\begin{enumerate}
    ...
    \item \textbf{Empirical application}: Comprehensive analysis of 25 proposed lanes in Jerusalem using real population, employment, and network data
...
Wishing List Lanes & Author & 25 proposed future lanes \\
...
Table~\ref{tab:wishing_list} presents the 25 proposed bike lanes evaluated in this study.
...
\midrule
1 & Ha'Ari-Metudela & Central-West & 482 \\
2 & Agron-Ramban & City center & 785 \\
3 & Keren HaYesod-King George & Commercial corridor & 1,650 \\
4 & Derech Hebron & Southern spine & 4,850 \\
5 & Jabotinsky & East-West connector & 1,120 \\
6 & George Adam Smith-Lehi & Northern residential & 620 \\
7 & Herzl & Western arterial & 2,480 \\
8 & Ben Zakai-Yehuda HaNasi & German Colony & 1,720 \\
9 & Rachel Imenu-Hizkiyahu & Southern neighborhoods & 1,340 \\
...
13 & Elazar HaModa'i-Katamon & Katamon link & 890 \\
14 & HaPalmach & Southern central & 730 \\
15 & Bezek-Beit & Nayot-Herzl connection & 1,850 \\
16 & Yirmiyahu-Bar Ilan-Eshkol & Northern East-West & 3,480 \\
...
22 & Pierre Koenig & South-Central & 1,340 \\
23 & Shamgar-Ohel Yehoshua & Northern connector & 1,720 \\
24 & Bezalel-Rabin & Cultural corridor & 2,180 \\
...
\centering
\begin{tikzpicture}
    % Placeholder for accessibility map
    \draw[thick] (0,0) rectangle (10,7);
    \node[align=center] at (5,3.5) {\textit{Figure placeholder:}\\ \textit{Baseline Origin Accessibility by Statistical Area}\\ \textit{Color scale: Red (low) to Green (high)}};
\end{tikzpicture}
...
Table~\ref{tab:lane_rankings} presents the ranking of all 25 proposed lanes by their marginal contribution to city-wide accessibility at default parameters.
...
\centering
\begin{tikzpicture}
    % Placeholder for improvement map
    \draw[thick] (0,0) rectangle (10,7);
    \node[align=center] at (5,3.5) {\textit{Figure placeholder:}\\ \textit{Accessibility Improvement (\%) with Top 5 Lanes}\\ \textit{Darker shades indicate greater improvement}};
\end{tikzpicture}
