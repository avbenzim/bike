...
def create_heatmap(areas_gdf, N_values, bike_lanes, title, output_file, scenario_label):
    ...
    # Create custom colormap matching reference image: blue -> cyan -> yellow -> orange -> red
    # Blue = low accessibility, Red = high accessibility
    cmap_custom = LinearSegmentedColormap.from_list('spectral_acc',
        ['#0000CD', '#00CED1', '#FFFF00', '#FFA500', '#DC143C'], N=256)
